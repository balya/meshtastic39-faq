...
<body>
  ...
  <main class="layout">
    <aside class="sidebar" aria-label="Список вопросов">
    ...
    <section class="content" aria-label="Ответы">
      <p class="intro">Все статьи собраны на одной странице. Список слева ведёт к нужному ответу, поиск подсвечивает совпадения.</p>
